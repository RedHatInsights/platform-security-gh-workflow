...
SYFT_COMMIT_HASH="75455f050ab028977a6b625165e2ad3644fcc845"
GRYPE_COMMIT_HASH="baf391d5c672e8f409953baa49ea243265866b2c"

# Max allowed age for vulnerability database, age being the time since it was built
# Default max age is 336h (or 14 days) (env: GRYPE_DB_MAX_ALLOWED_BUILT_AGE)
export GRYPE_DB_MAX_ALLOWED_BUILT_AGE="336h0m0s"
